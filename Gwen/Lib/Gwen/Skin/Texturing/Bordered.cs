...
namespace Gwen.Skin.Texturing
{
    ...
    {
        public Texture MTexture { get; private set; }
        ...
        private void Init(Texture texture, float x, float y, float w, float h, Margin inMargin, float drawMarginScale = 1.0f)
        {
            ...
            Set(x, y, w, h, inMargin, drawMarginScale);
        }

        public void SetMargin(int left, int top, int right, int bottom)
        {
            Set(_x,_y,_w,_h,new Margin(left,top,right,bottom), _scale );
        }
        public void Set(float x, float y, float w, float h, Margin inMargin, float drawMarginScale)
        {
            m_Margin = inMargin;
        ...
        public void Draw(Renderer.Base render, Rectangle r, Color col)
        {
            ...
            {
                render.DrawTexturedRect(MTexture, r, m_Rects[0].uv[0], m_Rects[0].uv[1], m_Rects[8].uv[2], m_Rects[8].uv[3]);
                return;
            }
