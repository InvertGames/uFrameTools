...
namespace Invert.uFrame.VS
{
...

    {
        ...
        private const string fileExtension = ".ufgraph";
        ...
        public GraphWindow editorControl;
        ...
        private void PrivateInit()
        {
            ...
            editorControl = new GraphWindow();
            base.Content = editorControl;
        ...
        {
            var solutionService = (SVsProjectItem)GetService(typeof(SVsProjectItem));
            ...
            if (toolboxData == null)
            {
                ...
                ErrorHandler.ThrowOnFailure(toolbox.AddItem((IDataObject)toolboxData, itemInfo, "Toolbox Test"));
            }
        }
        ...
        int IPersistFileFormat.Load(string pszFilename, uint grfMode, int fReadOnly)
        {
            ...
            try
            {
                ...
                editorControl.Pane = this;
                
                // Load the file
                //editorControl.Diagram.ViewModel = new DiagramViewModel();
                // TODO LOAD FILE HERE
                editorControl.OpenGraph(fileName);
        ...
        public object GetSiteService(Type t)
        {
            return GetService(t);
        }
        /// <summary>
            ...
            switch (dwSave)
            {
                ...
                case VSSAVEFLAGS.VSSAVE_SilentSave:
                {
                    ...
                    switch ( (tagVSQuerySaveResult)result )
                    {
                        ...
                        default:
                            throw new COMException("COMException");
                    }
                    break;
                }
