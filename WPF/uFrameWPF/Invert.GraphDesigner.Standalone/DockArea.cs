...
namespace Invert.GraphDesigner.Standalone
{
    ...
    {   
       // private Control.Base m_LastControl;
        private readonly Gwen.Control.StatusBar m_StatusBar;
        private readonly Gwen.Control.ListBox m_TextOutput;
       // private Control.TabButton m_Button;
        private readonly Gwen.Control.CollapsibleList m_List;
      ...
      //  private readonly Control.LabeledCheckBox m_DebugCheck;
            ...
            : base(parent)
        {
           ...
           // m_List = new Gwen.Control.CollapsibleList(this);
            ...
            diagramControl = new DiagramControl(scrollControl.InnerPanel);
            scrollControl.SetInnerSize(5000,5000);
            diagramControl.ScrollContainer = scrollControl;
