...
namespace Invert.uFrame.VisualStudio.Project
{
    ...
    [ProjectTypeRegistration(VsPackage.ProjectTypeGuid, "uFrame Project", "#2", ProjectExtension, Language, resourcePackageGuid: VsPackage.PackageGuid, PossibleProjectExtensions = ProjectExtension, ProjectTemplatesDir = @"..\..\Templates\Projects\MyCustomProject")]
    ...
    internal class MyUnconfiguredProject
    {
        ...
        /// </summary>
        internal const string ProjectExtension = "ufproj";
        ...
        /// </remarks>
        internal const string UniqueCapability = "uFrameProject";

        internal const string Language = "uFrameProject";
