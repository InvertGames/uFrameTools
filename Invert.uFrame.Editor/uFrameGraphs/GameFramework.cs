...
namespace Invert.uFrame.Editor {
    ...
    public class GameFrameworkBase : Invert.Core.GraphDesigner.DiagramPlugin {
        ...
        private Invert.Core.GraphDesigner.NodeConfig<ElementComponentNode> _ElementComponent;
        
        private Invert.Core.GraphDesigner.NodeConfig<HandlerNode> _Handler;
        
        private Invert.Core.GraphDesigner.NodeConfig<BinderNode> _Binder;
        ...
        public Invert.Core.GraphDesigner.NodeConfig<ElementComponentNode> ElementComponent {
            get {
                return _ElementComponent;
            }
            set {
                _ElementComponent = value;
            }
        }
        ...
        public Invert.Core.GraphDesigner.NodeConfig<BinderNode> Binder {
            get {
                return _Binder;
            }
            set {
        ...
        public override void Initialize(Invert.Core.uFrameContainer container) {
            ...
            container.AddItem<Handlers>();
            container.AddItem<BinderComponentSlot>();
            ...
            Subsystem.HasSubNode<ElementComponentNode>();
            Subsystem.HasSubNode<BinderNode>();
            ...
            ElementComponent = container.AddNode<ElementComponentNode,ElementComponentNodeViewModel,ElementComponentNodeDrawer>("ElementComponent");
            ElementComponent.Color(NodeColor.Purple);
            ElementComponent.HasSubNode<HandlerNode>();
            ElementComponent.HasSubNode<BinderNode>();
            ElementComponent.HasSubNode<ElementViewNode>();
            Handler = container.AddNode<HandlerNode,HandlerNodeViewModel,HandlerNodeDrawer>("Handler");
            Handler.Color(NodeColor.Green);
            Binder = container.AddNode<BinderNode,BinderNodeViewModel,BinderNodeDrawer>("Binder");
            Binder.Color(NodeColor.YellowGreen);
            ...
            container.Connectable<BinderNode,CommandChildItem>();
            ...
            container.Connectable<IComponents,ComponentsReference>();
        }
    }
    ...
    public class ElementNodeBase : Invert.Core.GraphDesigner.GenericInheritableNode, IRegisteredInstance, IElementInputSlot {
        ...
        public virtual System.Collections.Generic.IEnumerable<IComponents> PossibleComponents {
            get {
                return this.Project.AllGraphItems.OfType<IComponents>();
            }
        }
        
        [Invert.Core.GraphDesigner.ReferenceSection("Components", SectionVisibility.Always, false, false, typeof(IComponents), false, OrderIndex=0, HasPredefinedOptions=false)]
    ...
    public class ElementComponentNodeBase : Invert.Core.GraphDesigner.GenericNode, IComponents, IBinderComponentSlot {
        
        private Handlers _HandlersOutputSlot;
        ...
        [Invert.Core.GraphDesigner.OutputSlot("Handlers", true, SectionVisibility.WhenNodeIsFilter, OrderIndex=0)]
        public virtual Handlers HandlersOutputSlot {
            get {
                return _HandlersOutputSlot;
            }
            set {
                _HandlersOutputSlot = value;
            }
        }
    }
    
    public class HandlerNodeBase : Invert.Core.GraphDesigner.GenericNode, IHandlers {
    ...
    public class BinderNodeBase : Invert.Core.GraphDesigner.GenericNode {
        ...
        [Invert.Core.GraphDesigner.Section("Signals", SectionVisibility.Always, OrderIndex=0)]
        public virtual System.Collections.Generic.IEnumerable<CommandChildItem> Signals {
            get {
                return ChildItems.OfType<CommandChildItem>();
            }
        }
    ...
    public class ElementComponentNodeViewModelBase : Invert.Core.GraphDesigner.GenericNodeViewModel<ElementComponentNode> {
        
        public ElementComponentNodeViewModelBase(ElementComponentNode graphItemObject, Invert.Core.GraphDesigner.DiagramViewModel diagramViewModel) : 
                base(graphItemObject, diagramViewModel) {
        }
    }
    
    public class HandlerNodeViewModelBase : Invert.Core.GraphDesigner.GenericNodeViewModel<HandlerNode> {
    ...
    public class BinderNodeViewModelBase : Invert.Core.GraphDesigner.GenericNodeViewModel<BinderNode> {
        
        public BinderNodeViewModelBase(BinderNode graphItemObject, Invert.Core.GraphDesigner.DiagramViewModel diagramViewModel) : 
                base(graphItemObject, diagramViewModel) {
        }
    }
    ...
    public class ElementComponentNodeDrawerBase : GenericNodeDrawer<ElementComponentNode,ElementComponentNodeViewModel> {
        
        public ElementComponentNodeDrawerBase(ElementComponentNodeViewModel viewModel) : 
                base(viewModel) {
        }
    }
    ...
    public class BinderNodeDrawerBase : GenericNodeDrawer<BinderNode,BinderNodeViewModel> {
        
        public BinderNodeDrawerBase(BinderNodeViewModel viewModel) : 
                base(viewModel) {
        }
    }
    ...
    public class HandlersBase : MultiOutputSlot<IHandlers> {
    ...
    public partial interface IHandlers : Invert.Core.GraphDesigner.IDiagramNodeItem, Invert.Core.GraphDesigner.IConnectable {
    }
    
    public class BinderComponentSlotBase : SingleInputSlot<IBinderComponentSlot> {
    ...
    public class ComponentsReferenceBase : Invert.Core.GraphDesigner.GenericReferenceItem<IComponents> {
